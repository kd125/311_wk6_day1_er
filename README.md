...
ANSWER: Last update is an attribute of the Inventory object, and the diamond being filled means its not NULL

3. How many foreign keys does the "payments" table have? How can you tell?

ANSWER: Staff ID, Customer ID, Payment Rental - the foreign keys are displayed under "Indexes" below the primary key
